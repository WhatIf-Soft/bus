...
import (
	...
	"github.com/busexpress/services/support/config"
	supporthttp "github.com/busexpress/services/support/internal/adapter/inbound/http"
	"github.com/busexpress/services/support/internal/adapter/outbound/postgres"
	"github.com/busexpress/services/support/internal/service"
)

func main() {
	rootCmd := &cobra.Command{Use: "support-service", Short: "BusExpress Support Service"}
...
func runServe(_ *cobra.Command, _ []string) error {
	...
	supporthttp.RegisterRoutes(r, svc, []byte(cfg.JWT.Secret))
	...
	go func() {
		logger.Info().Str("addr", addr).Msg("support-service started")
